...
## paths for image 1 and 2
im1 = '/home/harsha/Video_ShotThread_SceneDetect/data/bbt_s01e01_excerpt/bbt_s01e01_000258.jpg'
im2 = '/home/harsha/Video_ShotThread_SceneDetect/data/bbt_s01e01_excerpt/bbt_s01e01_000259.jpg'

def orb_feature_matching(img1, img2, n=1000):

    test1=cv2.imread(img1, cv2.IMREAD_COLOR)
    test2=cv2.imread(img2, cv2.IMREAD_COLOR)
